...
void setup () {
  ...
  //rtc.adjust(DateTime(2024, 3, 23, 10, 0, 0));
  ...
  while(1)
  {
    if (current_azimuth > sun_azimuth[0]) {
      ...
      work_0p1Degree();
      current_azimuth = current_azimuth + 0.1;
      delay(100); 
      //200+100=300ms, move 0.1 degree -> 5 minutes = 300000ms, 
      //300000/300 = 1000 times, 0.1 deg * 1000 times = 100.0 deg
    }
  }
